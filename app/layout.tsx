...
export const metadata: Metadata = {
  title: 'ContractorDocs.ai — Professional Contractor Document Templates',
  ...
  openGraph: {
    title: 'ContractorDocs.ai — Stop Losing Jobs Because You Had No Contract',
    ...
    url: 'https://contractordocs.ai',
    siteName: 'ContractorDocs.ai',
    type: 'website',
  },
  twitter: {
  ...
  metadataBase: new URL('https://contractordocs.ai'),
}
